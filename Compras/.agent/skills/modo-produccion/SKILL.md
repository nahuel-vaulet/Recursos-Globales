...
## Manejo de errores
- Si no puedes acceder al archivo principal, pide la ruta correcta.
- Si hay demasiados problemas (>15), prioriza los 8 más críticos primero.
- Si el objetivo no está claro, pregunta antes de aplicar cambios.
